...
class DataTrainingArguments:
    dataset_name: Optional[str] = field(
        ...
        metadata={"help": "The preference dataset to use if not using a local JSONL file."},
    )
    ...
    # ADDED: Path to local JSONL dataset.
    sql_dataset_path: Optional[str] = field(
        default=None,
        metadata={"help": "Path to local JSONL file (e.g., 'sql_result.jsonl'). If set, we use this dataset."},
    )
    # ADDED: Option to include assistant reasoning in the final output.
    include_assistant_reasoning: Optional[bool] = field(
        default=False,
        metadata={"help": "If True, output will include assistant_reasoning + '\\n' + sql_result. Otherwise just sql_result."},
    )
