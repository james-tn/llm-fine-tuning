...
def process_question(client, question, knowledge_graph_context):  
    """  
    Process a single question: craft the prompt, send the API request, and verify the SQL query.  
    """  
...
def main():  
    ...
    with ThreadPoolExecutor(max_workers=3) as executor:  
        ...
        future_to_question = {  
            executor.submit(process_question, client, question, knowledge_graph_context): question  
        ...
        for future in as_completed(future_to_question):  
            ...
            if result:  
                ...
                print(f"Processed question: {result['user']}")  
  
    # Save results to JSONL file  
    with open("sql_result__test_v5.jsonl", "w") as f:  
        for result in results:  
            f.write(json.dumps(result) + "\n")  
  
    print("Results saved to sql_result_v5.jsonl")  
